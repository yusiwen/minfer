...
| 8–9 | Memory placement policy: VRAM budget, layer offload, size-class allocator — **the budget, accounting, size-class pools (E4 S1 + S2) and the explicit layer offload (E5 S1) landed; the reserve/assign re-map and the automatic offload fit are open** | L3+L6 | L | 1–2 w |
