...
The round-by-round records that followed here (r28 → r59, formerly §11.8–§11.37)
were maintained round for round in BOTH this document and the per-step documents,
doubling the surface that had to be kept honest; on 2026-09-10 they were
consolidated. The authoritative copies are:

- **`CUDA_OPTIMIZATION.md` §0** — one row per round (commit, measured delta,
  status, one-line lesson), rows r28–r59;
- **`cuda_optimization_steps/31–64`** — one standalone chapter per round
  (31 = r28 NB kernel … 64 = r60 promotion), indexed by the master table's
  Part III/IV tables.

Anchors for older cross-references: former §11.8 = r28 Phase-2 outcome,
§11.26 = r47, §11.34 = r55, §11.36 = r58, §11.37 = r59. The design body above
