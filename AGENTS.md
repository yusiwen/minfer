...
- Real-model gates (the `#[ignore]`d set): one command — `scripts/real_model_gates.sh`
  ...
  **4 steps / 80** and **64 / 768** on the 0.5B. Under the same 16 spinners that run was **29 passed / 0
  ...
  On a CUDA box the set is **34 passed / 0 failed** (0.5B config, GB10 sm_121) and the Qwen3-0.6B
  configuration's set is **34 / 0**; both are still run with `--test-threads=1`. **#123 made the C4
  ...
  Qwen3-0.6B configuration's set is **34 passed / 0 failed** (measured 2026-09-25): the f16 KV
