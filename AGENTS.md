...
- Real-model gates (the `#[ignore]`d set): **run it serially** —
  ...
  Qwen3-0.6B configuration's set is **30 passed / 1 failed** (measured 2026-09-25 after C4 S2c):
