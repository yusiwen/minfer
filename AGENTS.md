...
| **CUDA roadmap (live): current GB10 perf vs llama.cpp, 8m–8p session record, remaining R1–R3 plan; Part IV keeps the pre-Phase-7 draft history with per-item outcomes.** (`docs/CUDA_PROBLEMS.md` = old problems list, pre-Phase-7) | `docs/CUDA_OPTIMIZATION.md` |
